...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edEmail = findViewById(R.id.editTextLTBContact);
            ...
            public void onClick(View v) {
                ...
                else
                {
                    if(password.compareTo(confirm)==0)
                    {
                        ...
                        {
                            Toast.makeText(getApplicationContext(), "Password must contain at last 8 characters ,having letter,digit and special symbol",Toast.LENGTH_SHORT).show();
